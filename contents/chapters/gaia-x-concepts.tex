...
The fact that policies in Gaia-X are machine-readable allows for automated contract negotiation between provider and consumer~\cite{gaiax_data_exchange_document}.
